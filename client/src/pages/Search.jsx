  ...
  return (
    <div className='t-0 l-0 h-vh w-[100%]'>
      <div className='relative w-[100%] px-[20px] h-[60px] pt-[10px]'>
        <div className=' pr-[40px] h-[40px]'>
          <input
            ...
            className='bg-[#181818] text-white h-[40px] w-[100%] rounded-[10px] text-[15px] pl-[10px] text-ellipsis overflow-hidden'
          ></input>
        </div>
      ...
      <div className='grid grid-col-3 grid-rows-2 grid-flow-col justify-between px-[20px] pt-[20px]'>
        {menu.map((v, i) => {
          return (
            <div className='h-[120px] w-[80px] relative'>
              ...
              <div className='h-[30px] w-[80px] relative flex my-[5px] justify-center items-center text-white'>
                {v.title}
              </div>
            </div>
          );
      ...
      <div className='text-[18px] text-white px-[20px] py-[7px]'>Популярные места</div>
