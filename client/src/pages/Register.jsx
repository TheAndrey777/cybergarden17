    ...
    <>
      <div className='z-10 absolute top-0 left-0 md:w-[400px] w-[100%] bg-black'>
        <div className=' t-0 l-0 h-dvh w-[100%] relative'>
          ...
          <div className='mx-[20px] mb-[10px] text-[#4D4D4D] light:text-[#181818]'>{'Имя'}</div>
          <div className='px-[20px]'>
            <input id='name' type='text' className={nameColor}></input>
          </div>
          <div className='mx-[20px] mb-[10px] text-[#4D4D4D] light:text-[#181818]'>{'Почта'}</div>
          <div className='px-[20px]'>
            <input id='email' type='email' className={emailColor}></input>
          </div>
          <div className='mx-[20px] mb-[10px] text-[#4D4D4D] light:text-[#181818]'>{'Пароль'}</div>
          <div className='px-[20px]'>
          ...
          <div className='px-[20px]'>
            <input id='password_repeat' type='password' className={passwordRepeatColor}></input>
          </div>
