  ...
  [&::-webkit-scrollbar-thumb]:rounded-full'
        >
          ...
          <Atchivment
            ...
            complet={1}
          />
          <Atchivment name='Первые шаги' description='Посетите 5 различных мест' complet={1} />
          <Atchivment name='Снидром отличника' description='Поставьте 30 оценок 5' complet={1} />
          <NavBar page={2} />
        </div>
      </div>
      <MapBar page={2} />
